 ...
 *
 * ZGuide is free software; you can redistribute it and/or modify it under the terms of the Lesser GNU General Public
 * License as published by the Free Software Foundation; either version 3 of the License, or (at your option) any later
 * version.
 *
 * ZGuide is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty
...
/**
 * Majordomo Protocol Client API, Java version Implements the MDP/Worker spec at http://rfc.zeromq.org/spec:7.
 *
 * @author Arkadiusz Orzechowski <aorzecho@gmail.com>
 */
public final class mdwrkapi {
